...
class PartyBookingController extends BaseController
{
    ...
    */
    ...
    //    dd("sdvsdfs");
        ...
        return view('admin.party_booking.index', compact('page', 'main_menu', 'sub_menu','sub_menu_1','user','title'))->render();
    }
    ...
    { 
        ...
        return view('admin.party_booking._types', compact('results','type'))->render();
    }
