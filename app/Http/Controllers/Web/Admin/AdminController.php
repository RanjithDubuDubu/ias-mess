...
class AdminController extends BaseController
{
    ...
    */
    ...
    public function getById(AdminDetail $admin)
    {
        ...
        return view('admin.admin.update', compact('item', 'services', 'page', 'countries', 'main_menu', 'sub_menu','sub_menu_1', 'roles'));
    }
    ...
    public function viewProfile(User $user)
    {
        ...
        return view('admin.admin.profile', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1', 'user'));
    }
