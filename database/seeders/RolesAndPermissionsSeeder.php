...
//Dashboard and ConfMESS_MANAGERurations
       PermissionSlug::ACCESS_DASHBOARD => [
        ...
        PermissionSlug::ADD_PARTY => [
            ...
            PermissionSlug::PARTY_BOOKING_MANAGEMENT => [
                'name' => 'party-booking-management',
                'description' => 'party-booking-management',
                'main_menu' => 'Bookings',
                'sub_menu' => null,
                'sort' => 12,
                'icon' => 'fa fa-cogs'
            ],
            PermissionSlug::LAWN_BOOKING_MANAGEMENT => [
                'name' => 'lawn-booking-management',
                'description' => 'lawn-booking-management',
                'main_menu' => 'Bookings',
                'sub_menu' => null,
                'sort' => 12,
                'icon' => 'fa fa-cogs'
    ...
    protected $roles = [
        ...
        RoleSlug::USER => [
            'name' => 'USER and TW User',
            'description' => 'USER and TW User',
            'permissions' => []
        ],
